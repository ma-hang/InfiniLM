...
INFINI_EXTERN_C __export struct DeepSeekV3Model *
createDeepSeekV3Model(const DeepSeekV3Meta *,
                      const DeepSeekV3Weights *);

INFINI_EXTERN_C DeepSeekV3Weights *
createDeepSeekV3Weights(const DeepSeekV3Meta *meta,
                        infiniDevice_t device,
                        int ndev,
                        const int *dev_ids);

INFINI_EXTERN_C __export DeepSeekV3WeightLoader *
createDeepSeekV3WeightLoader();

/// @brief 销毁模型
INFINI_EXTERN_C __export void destroyDeepSeekV3Model(struct DeepSeekV3Model *);

INFINI_EXTERN_C __export struct DeepSeekV3Cache *
